...
void ShapesApp::BuildShapeGeometry()
{
    ...
    GeometryGenerator::MeshData circle = geoGen.CreateGeosphere(4.0f, 0);
    ...
    circleSubmesh.IndexCount = (UINT)circle.Indices32.size();
	...
	geo->DrawArgs["circle"] = circleSubmesh;
...
void ShapesApp::BuildRenderItems()
{
	...
	//XMStoreFloat4x4(&circleRitem->World, XMMatrixScaling(2.0f, 2.0f, 2.0f)*XMMatrixTranslation(0.0f, 0.5f, 0.0f));
