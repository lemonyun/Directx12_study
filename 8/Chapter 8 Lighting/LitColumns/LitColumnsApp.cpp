...
void LitColumnsApp::UpdateMainPassCB(const GameTimer& gt)
{
	...
	for (int i = 0; i < 5; i++) {
		mMainPassCB.Lights[2 * i].Strength = { 0.6f, 0.6f, 0.6f };
		mMainPassCB.Lights[2 * i].Position = { -5.0f, 3.5f, -10.0f + i * 5.0f };

		mMainPassCB.Lights[2 * i + 1].Strength = { 0.6f, 0.6f, 0.6f };
		mMainPassCB.Lights[2 * i + 1].Position = { +5.0f, 3.5f, -10.0f + i * 5.0f };
	}
