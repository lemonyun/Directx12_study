...
//
//
//   fxc VecAdd.hlsl /Od /Zi /T cs_5_0 /E CS /Fo VecAdd_cs.cso /Fc
//    VecAdd_cs.asm
//
//
// Buffer Definitions: 
...
#line 33 "C:\Users\lemon\DirectX12Study\Directx12_study\13\연습문제 1~3\VecAdd\Shaders\VecAdd.hlsl"
...
sqrt r0.x, r0.x  // d<0:NaN:Inf>
imm_atomic_alloc r1.x, u1  // gOutput<0>
store_structured u1.x, r1.x, l(0), r0.x  // gOutput<0>
store_structured u1.x, r1.x, l(4), l(0)  // gOutput<0>
store_structured u1.x, r1.x, l(8), l(0)  // gOutput<0>
